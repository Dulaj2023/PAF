...
public class ProductService 
{
	...
	@FormParam("warrenty") String warrenty,
	@FormParam("productDesc") String productDesc)
	{
	String output = productObj.insertProduct(productName, productPrice, warrenty, productDesc);
	return output;
	}
	...
	String warrenty = productObject.get("warrenty").getAsString();
	String productDesc = productObject.get("productDesc").getAsString();
	
	String output = productObj.updateProduct(productID, productName, productPrice, warrenty, productDesc);
	return output;
	}
